...
import org.mumod.util.StringUtil;
...
/**
 * 
 * sqlite3 /data/data/org.mumod.android/databases/data
 * 
 * market://search/?q=pname:org.mumod.android.Mustard
 * 
 * @author macno
 *
 */
    ...
    public StatusNet checkAccount(MustardDbAdapter mDbHelper, boolean loadDefault, long userid) {
    	...
    	try {
    		if(accountCursor.moveToNext()) {
                ...
                int attachLimitIndex = accountCursor.getColumnIndexOrThrow(MustardDbAdapter.KEY_ATTACHLIMIT);
